...
const dualTrade = async (router1, router2, baseToken, token2, amount) => {
  ...
  try {
    ...
    const tx = await arb.connect(owner).dualDexTrade(router1, router2, baseToken, token2, amount, { gasPrice: 300000000, gasLimit: 500001 }); //{ gasPrice: 1000000000003, gasLimit: 500000 }
